...
public class EditCourseActivity extends IHWActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.title_activity_edit_courses);
        ...
        nameBox.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().equals("")) setTitle(R.string.add_course);
    ...
    protected void onStart() {
        ...
        if (existingCourseName != null) {
            ...
            for (int i = 1; i <= numDays; i++) {
                if (c.getMeetingOn(i) == Constants.MEETING_SINGLE_PERIOD)
        ...
        if (item.getItemId() == R.id.action_delete) {
            ...
            if (numMeetings > 0 && !nameBox.getText().toString().equals("")) {
                ...
                for (int i = 0; i < numDays; i++) {
                    ...
                    else if (meetingBoxes[0][i].isChecked())
                        meetings[i] = Constants.MEETING_DOUBLE_BEFORE;
                    else if (meetingBoxes[2][i].isChecked())
                ...
                if (!success) {
                    ...
                    Toast.makeText(this, R.string.toast_course_conflict, Toast.LENGTH_LONG).show();
                } else {
