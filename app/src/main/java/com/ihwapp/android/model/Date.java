...
public class Date extends GregorianCalendar {
    ...
    public String getDayOfWeek(boolean shortVersion) {
        if (shortVersion)
            return this.getDisplayName(GregorianCalendar.DAY_OF_WEEK, GregorianCalendar.SHORT, Locale.getDefault());
        else
            return this.getDisplayName(GregorianCalendar.DAY_OF_WEEK, GregorianCalendar.LONG, Locale.getDefault());
    }
