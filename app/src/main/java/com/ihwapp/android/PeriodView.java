...
public class PeriodView extends LinearLayout implements DayFragment.OnFragmentVisibilityChangedListener {
    ...
    private void addAnotherNoteBox(Note n) {
        ...
        ((CheckBox) v.findViewById(R.id.checkbox)).setOnCheckedChangeListener(
        ...
        if (n == null) bottomIsEmpty = true;
            ...
            if (!n.getText().equals(""))
                ((TextView) v.findViewById(R.id.text_bullet)).setTextColor(Color.BLACK);
            if (n.isToDo()) {
    ...
    public void addCountdownTimerIfNeeded() {
        ...
        if (this.period.getDate().equals(new Date())) {
            ...
            if (secondsUntil > 0 &&
                    ((this.period.getIndex() > 0 && d.getPeriods().get(this.period.getIndex() - 1)
                            .getStartTime().secondsUntil(now) > 0)
    ...
    private class OptionsMenuListener implements OnClickListener, PopupMenu.OnMenuItemClickListener {
        ...
        public void onClick(View v) {
            ...
            if (cb.getVisibility() == View.VISIBLE)
                toDoItem.setTitle(R.string.option_hide_checkbox);
            ...
            if (pixelsToSp(getContext(), ((EditText) noteRow.findViewById(R.id.text_note)).getTextSize()) == SIZE_MEDIUM)
                importantItem.setTitle(R.string.option_mark_important);
