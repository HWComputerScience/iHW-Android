...
public class DayFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (day.getCaption() != null && !day.getCaption().equals("")) {
            dayCaptionText.setText(day.getCaption());
            Log.d("iHW", "Creating caption link: " + day.getCaptionLink());
            if (day.getCaptionLink() != null && !day.getCaptionLink().equals("")) {
    ...
    public void onResume() {
        ...
        final ScrollView sv = (ScrollView) getView().findViewById(R.id.scroll_periods); // TODO eliminate NPE possibility
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("scrollPos", getView().findViewById(R.id.scroll_periods).getScrollY()); // TODO eliminate NPE possibility
    }

    public void onPause() {
        super.onPause();
        //Log.d("iHW-lc", "DayFragment (" + this + ") onPause: " + date);
        initScrollPos = getView().findViewById(R.id.scroll_periods).getScrollY(); // TODO eliminate NPE possibility
    ...
    public void addOnFragmentVisibilityChangedListener(OnFragmentVisibilityChangedListener l) {
        ofvcls.add(l);
    }
